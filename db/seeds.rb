...
s1 = Scene.create(title_text: "Get started!", scene_text: "Start: You wake up in your room, turn on the news, and realize you are in the middle of the zombie apocolypse. What will you do? A.) Stay inside B.) Go Outside?")
