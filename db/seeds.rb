...
s1 = Scene.create(lose: nil, title_text: "Start Game", scene_text: "Start: You wake up in your room, turn on the news, and realize you are in the middle of the zombie apocolypse. What will you do? Enter 1 or 2.")
s2 = Scene.create(lose: nil, title_text: "It's scary outside. Stay inside", scene_text: "You decided to stay inside, zombies found you, climbed through your windows, and now you're dead ya dingus")
...
option3 = Option.create(base_scene_id: 2, next_scene_id: 1)
option4 = Option.create(base_scene_id: 2, next_scene_id: 8)
option5 = Option.create(base_scene_id: 3, next_scene_id: 4)
option6 = Option.create(base_scene_id: 3, next_scene_id: 5)
option7 = Option.create(base_scene_id: 4, next_scene_id: 1)
option8 = Option.create(base_scene_id: 4, next_scene_id: 8)
option9 = Option.create(base_scene_id: 5, next_scene_id: 6)
option10 = Option.create(base_scene_id: 5, next_scene_id: 7)
option11 = Option.create(base_scene_id: 6, next_scene_id: 1)
option12 = Option.create(base_scene_id: 6, next_scene_id: 8)
